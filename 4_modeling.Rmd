...
selected_mods2[[i]] <- model_trend(ind_tbl = ind_trend_inputs[ ,-1],
  time = ind_trend_inputs$annual_time_step, k = 10, family = Tweedie(p =2))
...
for (i in seq_along(scenario_indicator_single)){
  ...
  first_derivatives[[i]] <- get_derivs(selected_mods[[i]],
                                       scenario_indicator_single[[i]],
                                       290,
                                       "annual_time_step")
}

first_derivatives[[1]][[2]]
first_derivatives[[2]][[2]]
first_derivatives[[3]][[2]]
first_derivatives[[4]][[2]]
first_derivatives[[5]][[2]]
first_derivatives[[6]][[2]]
first_derivatives[[7]][[2]]
first_derivatives[[8]][[2]]
first_derivatives[[9]][[2]]
first_derivatives[[10]][[2]]
first_derivatives[[11]][[2]]
first_derivatives[[12]][[2]]
