...
plot_bootstrapped_model <- function(data, dev_explained){
  
indicator <- data$indicator[1]

boot_theme <- theme_classic +
...
boot_plot <- ggplot(data = data) +
    geom_rect(aes(xmin = 95, xmax = 105,
                ymin = -Inf, ymax = Inf), fill = "grey70", alpha = 0.3) +
  #Add background shading
  geom_rect(aes(xmin = 195, xmax = 205,
                ymin = -Inf, ymax = Inf), fill = "grey70", alpha = 0.3)+
            geom_point(aes(x = annual_time_step, y = observed), alpha = 0.4, size = 1) +
  geom_line(aes(x = annual_time_step, y = observed), alpha = 0.4) +
  ...
  geom_ribbon(aes(x = annual_time_step, ymin = predicted_lower, 
   ...
   geom_line(aes(x = annual_time_step, y = negative_trend), col = "#440154FF") +
                   theme_classic() +
   annotate("text", x = 295, y = 1.1, label = paste("Dev. explained =",
                                                    dev_explained, 
                                                    sep = " "), size = 4) +
  theme(panel.grid.major = element_blank(),
        panel.grid.minor = element_blank(),
...
boot_plot <- ggplot(data = data) +
  ...
  geom_line(aes(x = annual_time_step, y = negative_trend), col = "#440154FF") +
  geom_line(aes(x = annual_time_step, y = robust_negative_trend), col = "#440154FF", size = 2) +
   annotate("text", x = 295, y = 1.1, label = paste("Dev. explained =",
                                                    dev_explained, 
                                                    sep = " "), size = 6) +
                    theme_classic() +
  theme(panel.grid.major = element_blank(),
   ...
   labs(x = "Time (years)",
        y = indicator) +
   # guides(fill = guide_legend(title = "Rate of decline category",
   #                            nrow = 1)) +
    geom_vline(xintercept=c(100,200), linetype="dotted") 
...
boot_plot <- ggplot(data = data) +
  ...
  geom_ribbon(aes(x = annual_time_step, ymin = predicted_lower, 
   ...
   geom_line(aes(x = annual_time_step, y = positive_trend), col = "#2A788EFF") +
  geom_line(aes(x = annual_time_step, y = negative_trend), col = "#440154FF") +
  geom_line(aes(x = annual_time_step, y = robust_positive_trend), col = "#2A788EFF", size = 2) +
   annotate("text", x = 295, y = 1.1, label = paste("Dev. explained =",
                                                    dev_explained, 
                                                    sep = " "), size = 6) +
  theme(panel.grid.major = element_blank(),
  ...
  geom_rect(aes(xmin = 195, xmax = 205,
                ymin = -Inf, ymax = Inf), fill = "grey70", alpha = 0.3)+
  geom_point(aes(x = annual_time_step, y = observed), alpha = 0.2, size = 1) + 
  geom_line(aes(x = annual_time_step, y = observed), alpha = 0.4) +
  geom_line(aes(x = annual_time_step, y = predicted)) +
  geom_ribbon(aes(x = annual_time_step, ymin = predicted_lower, 
                  ymax = predicted_upper),
  ...
  geom_line(aes(x = annual_time_step, y = robust_positive_trend), col = "#2A788EFF", size = 2) +
  geom_line(aes(x = annual_time_step, y = robust_negative_trend), col = "#440154FF", size = 2) +
  annotate("text", x = 295, y = 1.2, label = paste("Dev. explained =",
                                                    dev_explained, 
                                                    sep = " "), size = 6) +
  labs(x = "Time (years)", y = indicator) +
  geom_vline(xintercept=c(100,200), linetype="dotted") +
  boot_theme
...
i <- 4 #Ignore first 3 because they're baseline
