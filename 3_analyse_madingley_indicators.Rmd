...
scenario_smoothed_abundance <- readRDS("N:/Quantitative-Ecology/Indicators-Project/Serengeti/Outputs_from_indicator_code/Indicator_outputs/2021-09-09_smoothed_abundance_5.rds")
```
...
```
# Plot the Red List Status breakdown per timestep
...
# Plot the temporal variance of the indicator values
...
# Modelling mess, proceed at your own risk
