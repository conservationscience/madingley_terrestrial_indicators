...
title <- ggdraw() + draw_label("Primary producer harvesting", fontface='bold')  
title2 <- ggdraw() + draw_label(" ", fontface='bold')  
...
ggsave(file.path(supporting_info_plots_folder, "land_use_spp_density.png"),
       lu_spp_density,  width = 14, height = 18, dpi = 300, 
       units = "in",device = "png")
...
ggsave(file.path(supporting_info_plots_folder, "carnivore_spp_density.png"),
       ca_spp_density,  width = 14, height = 18, dpi = 300, 
       units = "in",device = "png")
...
ggsave(file.path(supporting_info_plots_folder, "herbivore_spp_density.png"),
       he_spp_density,  width = 14, height = 18, dpi = 300, 
       units = "in",device = "png")
...
ggsave(file.path(manuscript_plots_folder, "red_list_v_abundance.png"),
       plot,  width = 10, height = 8, dpi = 600, 
       units = "in",device = "png")


```

# Everything below is set to eval = FALSE because it is old exploratory analysis. Delete for final MS.
