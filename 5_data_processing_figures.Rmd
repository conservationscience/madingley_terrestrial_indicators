...
ggsave(file.path(supporting_info_plots_folder, "3_weird_groups_rm.png"),
       width = 14,
       height = 8,
       units = "cm",
       abundance_plot2)
...
ggsave(file.path(supporting_info_plots_folder, "4_decomposed.png"),
       width = 14,
       height = 8,
       units = "cm",
       decomposed_plot)
...
ggsave(file.path(supporting_info_plots_folder, "5_averaged_abundance.png"),
       width = 8,
       height = 8,
       units = "cm",
       averaged_plot)
...
ggsave(file.path(supporting_info_plots_folder, "6_smoothed.png"),
       width = 8,
       height = 8,
       units = "cm",
       smoothed_plot)
